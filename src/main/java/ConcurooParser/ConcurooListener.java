...
/**
 * This interface defines a complete listener for a parse tree produced by {@link ConcurooParser}.
 */
public interface ConcurooListener extends ParseTreeListener {
  ...
  /**
   * Enter a parse tree produced by {@link ConcurooParser#blockItemList}.
   *
   * @param ctx the parse tree
   */
  void enterBlockItemList(ConcurooParser.BlockItemListContext ctx);

  /**
   * Exit a parse tree produced by {@link ConcurooParser#blockItemList}.
   *
   * @param ctx the parse tree
   */
  void exitBlockItemList(ConcurooParser.BlockItemListContext ctx);

  /**
   * Enter a parse tree produced by {@link ConcurooParser#blockItem}.
   *
   * @param ctx the parse tree
   */
  void enterBlockItem(ConcurooParser.BlockItemContext ctx);

  /**
   * Exit a parse tree produced by {@link ConcurooParser#blockItem}.
   *
   * @param ctx the parse tree
   */
  void exitBlockItem(ConcurooParser.BlockItemContext ctx);
