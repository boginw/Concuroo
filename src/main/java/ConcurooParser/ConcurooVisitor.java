...
public interface ConcurooVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ConcurooParser#blockItemList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBlockItemList(ConcurooParser.BlockItemListContext ctx);
	/**
	 * Visit a parse tree produced by {@link ConcurooParser#blockItem}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBlockItem(ConcurooParser.BlockItemContext ctx);
	/**
